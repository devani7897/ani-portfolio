      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="mt-4 text-lg text-gray-600 dark:text-gray-300">
            Have a project in mind or want to discuss backend solutions? Reach out!
          </p>
        </div>
        ...
        <div className="mt-12 text-center">
          <h3 className="text-lg font-medium text-gray-900 dark:text-white">Or connect directly</h3>
